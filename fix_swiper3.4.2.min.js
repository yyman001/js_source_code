...
}return this}},text:function(text){if(typeof text==="undefined"){if(this[0]){return this[0].textContent.trim()}else{return null}}else{for(var i=0;i<this.length;i++){this[i].textContent=text}return this}},is:function(selector){if(!this[0]){return false}var compareWith,i;if(typeof selector==="string"){var el=this[0];if(el===document){return selector===document}if(el===window){return selector===window}if(el.matches){return el.matches(selector)}else{if(el.webkitMatchesSelector){return el.webkitMatchesSelector(selector)}else{if(el.mozMatchesSelector){return el.mozMatchesSelector(selector)}else{if(el.msMatchesSelector){return el.msMatchesSelector(selector)}else{compareWith=$(selector);for(i=0;i<compareWith.length;i++){if(compareWith[i]===this[0]){return true}}return false}}}}}else{if(selector===document){return this[0]===document}else{if(selector===window){return this[0]===window}else{if(selector.nodeType||selector instanceof Dom7){compareWith=selector.nodeType?[selector]:selector;for(i=0;i<compareWith.length;i++){if(compareWith[i]===this[0]){return true}}return false}return false}}}},index:function(){if(this[0]){var child=this[0];var i=0;while((child=child.previousSibling)!==null){if(child.nodeType===1){i++}}return i}else{return undefined}},eq:function(index){if(typeof index==="undefined"){return this}var length=this.length;var returnIndex;if(index>length-1){return new Dom7([])}if(index<0){returnIndex=length+index;if(returnIndex<0){return new Dom7([])}else{return new Dom7([this[returnIndex]])}}return new Dom7([this[index]])},append:function(newChild){var i,j;for(i=0;i<this.length;i++){if(typeof newChild==="string"){var tempDiv=document.createElement("div");tempDiv.innerHTML=newChild;while(tempDiv.firstChild){this[i].appendChild(tempDiv.firstChild)}}else{if(newChild instanceof Dom7){for(j=0;j<newChild.length;j++){this[i].appendChild(newChild[j])}}else{this[i].appendChild(newChild)}}}return this},prepend:function(newChild){var i,j;for(i=0;i<this.length;i++){if(typeof newChild==="string"){var tempDiv=document.createElement("div");
